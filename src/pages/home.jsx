        ...
        <div className='row m-0 mt-5 p-0 position-relative'>
            ...
            <div className="m-0 col-12 row d-flex justify-content-center align-items-center flex-column flex-lg-row">
                <div className="col-12 col-lg-6 col-md-10 col-xl-5 row d-flex gap-3">
                    <h4 className='text-info d-flex gap-2'>Explore the World
                        <img src={miniWorld} alt="Mini World Image" className="img-fluid" />
                    </h4>
                    <h1 className='display-3'>Let’s find your<br />dream <span className="text-orange">Destination</span><br /> make with enjoy</h1>
                    <p className="lead">Travor is one of the most popular Travel agency for those who want to explore the wold and try to make adventure</p>
                    <div className=" d-flex py-0 p-0 px-3 gap-4 h-fit">
                        <span className="btn btn-oranged px-4 br-20 h-fit text-light fw-bold">Plan a Trip</span>
                        <span className="btn text-decoration-underline text-info h-fit">Get price</span>
                    </div>
                </div>
                <div className="col-10 col-lg-6 col-xl-5 d-flex align-items-center justify-content-lg-end justify-content-center my-4 my-lg-0">
            ...
            <div className="m-0 row d-flex align-items-center justify-content-center">
                <h1 className="col-12 col-md-8 text-center fw-bold">We <span className="text-orange">always</span> focus on best Benefits as well as Professional Service</h1>
            ...
            <div className="row d-flex m-0 justify-content-between align-items-center mb-5 px-lg-5 px-md-3">
                <div className="col-12 col-lg-5 col-md-7 d-flex flex-column">
            ...
            <div className="row d-flex m-0 my-5 justify-content-center align-items-center gap-4">
                ...
                <div className="col-12 col-lg-6 col-md-10 col-xl-6 row d-flex gap-3 my-md-3">
                    <h4 className='text-info d-flex gap-2'>Welcome to Travor
                        <img src={cooler} alt="Mini World Image" className="img-fluid" />
                    </h4>
                    <h1 className='display-5 col-12'>We Recommend<br /> Beautiful <span className="text-orange">Destination</span><br /> every month dream </h1>
                    <p className="lead col-12">Travor is one of the most popular Travel agency for those who want to explore the wold and try to make adventure as well as we can provide beautiful  destination around the world and make you trip</p>
                    <span className="btn btn btn-oranged px-4 py-2 rounded-pill w-fit h-fit text-light fw-normal fs-6 ">Learn More</span>
                </div>
            </div>
            <div className="m-0 row d-flex flex-column justify-content-center align-items-center">
                <h4 className='text-info d-flex gap-2 col-12 justify-content-center'>
                    Tour Packages
                    <img src={travelIcon} alt="badge icon" className="img-fluid" width={30} />
                </h4>
                <h1 className='display-6 fw-bold gap-1 d-flex justify-content-center'>
                    Most <span className="text-orange text-decoration-underline">Attractive</span> Packages
                </h1>
                <p className="lead col-11 col-md-8 col-lg-5 text-center">Travor is one of the most popular Travel agency for who want to explore the wold with adventure</p>
            </div>
            ...
            <div className="container-fluid m-0 row justify-content-center align-items-start position-relative">
                <img src={travelImg1} alt="Book Now" className='travel-img d-none d-md-block col-4 col-md-4' />
                <div className="col-12 col-lg-5 col-md-5 row d-flex justify-content-center align-items-center ">
                    <h3 className="lead text-center text-info fw-normal">Avail your Discount offer now!</h3>
                    <h2 className='text-center'>Grab <span className="text-orange ">up to 35% off</span> on<br />your favorite Destination</h2>
                    <p className="lead text-center my-4">Limited time offer, don’t miss the opportunity</p>
                    <span className="btn px-4 br-20 w-fit bg-info">Book Now</span>
                </div>
                <img src={travelImg2} alt="Explore the world" className='travel-img my-5 my-lg-0 col-12 col-sm-10  col-md-3' />
            ...
            <div className="container-fluid m-0 row py-5 justify-content-lg-center gap-2">
                <div className="col-12 col-md-8 col-lg-3 py-3 align-self-start">
                    <h5 className='text-info d-flex gap-2'>
                        Discount offer
                    ...
                    <span className="btn btn-warning rounded-pill px-4 py-2 my-3 fs-6 ">View More</span>
                </div>
            ...
            <div className="container-fluid row m-0 d-flex justify-content-center align-items-center">
                <div className="col-12 col-sm-9 col-lg-5  col-md-7 d-flex-justify-content-center-align-item-center pb-4 pb-md-5 pb-lg-0 ">
                    <img src={testimonial} alt="Testimonial Banner" className="img-fluid" />
                </div>
                <div className="col-12 col-sm-9 col-md-7  col-lg-5 d-flex flex-column">
                    <h4 className='text-info d-flex gap-2'>
                        Our Testimonials
                        <img src={badgeIcon} alt="badge icon" className="img-fluid" width={30} />
                    </h4>
                    <h1 className='display-5 col-12 fw-bold'>Happy <span className="text-orange">Travelers</span> <span className="text-info">expression</span></h1>
                    <div className="lead col-12 py-4 d-flex flex-column gap-3">
                        <span className="display-6 fw-bold text-dark p-0 fs-1"><Quotes/></span>
                        <p>Travor is one of the most popular Travel agency for those who want to explore the wold and try to make adventure as well as we can provide</p>
                    </div>
                    <div className="d-flex flex-column">
                        <h5 className="text-info">Tony Smith</h5>
                        <h6 className="text-dark fw-normal">Banker, Thailand</h6>
                    </div>
                </div>x-
            </div>
            <Subcribe />
