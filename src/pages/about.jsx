...
function About() {
    ...
    const Teamcard = (props) => {
        return (
            <div className={`p-3 br-20 white-bg d-flex flex-column align-items-center justify-content-center ${props.className}`} data-aos={props.animation}>
                <img src={props.obj.img} alt={props.obj.name} className='br-20 col-12' />
    ...
    return (
        <div className='row d-flex flex-column justify-content-center align-items-center'>
            ...
            <Features />
            <div className="row d-flex m-0 justify-content-left align-items-center mb-3 px-lg-5 px-md-3">
            ...
            <div className='row d-flex m-0 justify-content-evenly gap-3 px-md-5 flex-lg-nowrap p-0 '>
                {
                    teamInfo.map((e) => {
                        return (
                            <Teamcard
                                className="col-10 cur-pointer col-sm-5 col-md-4 col-lg-3 bg-light m-0"
                                obj={e}
                                animation={e.id % 2 == 0 ? "fade-left" : "fade-right"}
                            />
                        )
                    })
                }
