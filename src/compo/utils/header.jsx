function Header(props) {
    ...
    return (
        <div className={`col-12 py-0 row d-flex align-items-center justify-content-center ${props.className}`}>
            <h5 className={`text-info text-center ${type == "subPage" ? "fs-4" : "fs-2"}`} >{props.title1}</h5>
            <h3 className={`fw-bold text-center ${type == "subPage" ? "display-6" : "display-4"}`}>{props.title2}</h3>
