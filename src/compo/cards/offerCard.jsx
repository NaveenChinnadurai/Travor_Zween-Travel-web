...
function OfferCard(props) {
    return (
        <div className={`row d-flex col-10 col-sm-5 m-0 p-3 white-bg br-20 cur-pointer card-hover ${props.className}`} data-aos={props.animation}>
            <div className="col-12 p-0 position-relative">
                <img src={props.obj.img} alt={props.obj.title} className="w-100 br-20" />
                <span className="btn bg-info fw-bold text-light rounded-pill position-absolute offer-text">35% OFF</span>
            </div>
            <div className="col-12 p-0 mt-2 d-flex flex-column gap-2">
                ...
                <h4 className='p-0 col-12 m-0 offer-title'>{props.obj.packageInfo.title}</h4>
            </div>
            ...
            <div className="d-flex justify-content-between align-items-center p-0 py-2">
                ...
                <span className="border rounded-pill border-warning h-fit px-3 py-0 fs-6">Book</span>
            </div>
        </div>
    )
}
