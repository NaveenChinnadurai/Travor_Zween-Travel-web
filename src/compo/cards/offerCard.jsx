...
function OfferCard(props) {
    return (
        <div className={`row d-flex col-10 col-sm-5 m-0 p-3 white-bg br-20 ${props.className}`} data-aos={props.animation}>
            ...
            <div className="col-12 p-0 mt-2 d-flex flex-column gap-2">
                ...
                <h4 className='p-0 col-12 m-0'>{props.obj.packageInfo.title}</h4>
            </div>
