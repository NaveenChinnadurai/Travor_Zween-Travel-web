        ...
        <div className='m-0 row p-4 px-lg-5 d-flex justify-content-between align-item-lg-center navbar-div'>
            ...
            <div className={mobileView}>
                ...
                <div className="p-0 d-lg-flex d-flex flex-column flex-lg-row my-lg-0 my-3 gap-2 align-items-center ">
                    <span className="btn btn-outline px-4 d-flex align-items-center w-fit">Login</span>
                    <span className="btn btn-primary rounded-pill px-4 d-flex align-items-center w-fit">Signup</span>
                </div>
            </div>
