...
function Subcribe() {
    return (
        <div className='m-0 row justify-content-center bg-light p-5'>
            <div className="col-12 col-md-4 col-lg-4 d-flex flex-column justify-content-center align-items-start">
            ...
            <div className="col-12 col-md-7 col-lg-6 d-flex flex-column gap-3 align-items-start align-items-md-center justify-content-center position-relative p-0">
